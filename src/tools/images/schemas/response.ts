...
const QuerySchema = z.object({
  ...
  spellcheck_off: z
    .boolean()
    .optional()
    .describe("Whether spellcheck was disabled."),
...
const PropertiesSchema = z.object({
  ...
  placeholder: z
    .url()
    .optional()
    .describe("The lower resolution placeholder image."),
...
export const ExtraSchema = z.object({
  might_be_offensive: z
    .boolean()
    .describe("Whether the image might be offensive."),
})
...
export const ImageSearchApiResponseSchema = z.object({
  ...
  results: z
    .array(ImageResultSchema)
    .describe("The results of the image search."),
